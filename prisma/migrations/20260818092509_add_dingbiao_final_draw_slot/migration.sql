/*
  ...
  - Added the required column `finalDrawSlot` to the `DingbiaoScenario` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_DingbiaoScenario" ("benchmarkPriceM", "createdAt", "dingbiaoK1", "finalDrawValue", "finalistCount", "id", "inputRevision", "projectId", "qingbiaoK2Value", "qingbiaoScenarioId", "ruleVersion", "updatedAt", "version") SELECT "benchmarkPriceM", "createdAt", "dingbiaoK1", "finalDrawValue", "finalistCount", "id", "inputRevision", "projectId", "qingbiaoK2Value", "qingbiaoScenarioId", "ruleVersion", "updatedAt", "version" FROM "DingbiaoScenario";
